  ...
  variants: {
    variant: {
      ...
      "heading/Large SemiBold":
        "font-highlight text-5xl leading-xl tracking-normal font-semibold",
      "heading/Large Medium":
        "font-highlight text-5xl leading-xl tracking-normal font-medium",
      "heading/Regular Bold":
        "font-highlight text-3xl leading-xl tracking-normal font-bold",
      "heading/Regular Medium":
        "font-highlight text-3xl leading-xl tracking-normal font-medium",
      "heading/Regular Regular":
        "font-highlight text-3xl leading-xl tracking-normal",
      "heading/Small Bold":
        "font-highlight text-2xl leading-2xl tracking-normal font-bold",
      "heading/Small Medium":
        "font-highlight text-2xl leading-2xl tracking-normal font-medium",
      "heading/Small Regular":
        "font-highlight text-2xl leading-2xl tracking-normal",
      "heading/XSmall Medium":
        "font-highlight text-xl leading-xl tracking-normal font-medium",
      "label/Large Bold": "font-main text-l leading-xs tracking-wide font-bold",
      "label/Large Medium":
        "font-main text-l leading-xs tracking-wide font-medium",
      "label/Large Regular": "font-main text-l leading-xs tracking-wide",
      "label/Regular Bold":
        "font-main text-m leading-2xs tracking-wide font-bold",
      "label/Regular Bold Mono":
        "font-mono text-m leading-2xs tracking-wide font-bold",
      "label/Small Bold":
        "font-main text-s leading-3xs tracking-wide font-bold",
      "label/Small Medium":
        "font-main text-s leading-3xs tracking-wide font-medium",
      "label/Small Medium Mono":
        "font-mono text-s leading-3xs tracking-wide font-medium",
      "label/XSmall SemiBold":
        "font-main text-xs leading-4xs tracking-wide font-semibold",
