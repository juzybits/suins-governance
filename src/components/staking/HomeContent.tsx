...
function PanelHero() {
  return (
    <div className="panel">
      ...
      <h2>Participate in governance, earn rewards, and shape the future of SuiNS</h2>
...
function PanelNotes() {
  return <div className="panel">
    ...
    <ul>
      <li>During active governance votes, staked tokens cannot be unstaked</li>
...
function PanelFAQ() {
  return <div className="panel">
    ...
    <div>
      <p>Stake your tokens with flexibility to unstake anytime (after cooldown period)</p>
      <br/>
      <div>
        <h4>KEY FEATURES:</h4>
        <ul>
    ...
    <div>
      ...
      <div>
        ...
        <ul>
          ...
          <li>Rewards are distributed automatically after proposal completion</li>
